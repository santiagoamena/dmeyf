...
palancas$variablesdrift  <- c("ccajas_transacciones", "Master_mpagominimo",
                              "tpaquete1","tpaquete2","ctarjeta_debito")   #aqui van las columnas que se quieren eliminar
...
correr_todo  <- function( palancas )
{
  ...
  if( palancas$lag9 )   Lags( dataset, cols_analiticas, 9, palancas$delta6 )
  if( palancas$lag12 )  Lags( dataset, cols_analiticas, 12, palancas$delta6 )
